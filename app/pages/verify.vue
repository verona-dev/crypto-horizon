<template>
    <div class='page gap-24'>
        ...
        <div class='flex gap-8'>
            <NuxtLink to='/'>
                <Button variant='outline' size='lg' class='w-42 button-hover' aria-label='home'>Home</Button>
            </NuxtLink>
            
            <NuxtLink to='/profile'>
                <Button variant='outline' size='lg' class='w-42 button-hover' aria-label='profile'>Profile</Button>
            </NuxtLink>
        </div>
    </div>
</template>
