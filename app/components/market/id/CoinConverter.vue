        ...
        <div>
            ...
            <div class='relative h-12'>
                ...
                <Input
                    ...
                    type='text'
                    id='coin'
                    class='bg-muted h-full pl-18 focus-visible:border-primary/50 focus-visible:ring-[0px] rounded-bl-none rounded-br-none'
            ...
            <div class='relative h-12'>
                ...
                <Input
                    ...
                    type='text'
                    id='usd'
                    class='bg-muted h-full pl-18 focus-visible:border-primary/50 focus-visible:ring-[0px] rounded-tl-none rounded-tr-none'
