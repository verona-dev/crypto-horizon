<template>
    <CardContent class='coin-body px-0'>
        <section class='coin-intro flex flex-col lg:flex-row gap-30 justify-evenly lg:items-start'>
            <!--  Left  -->
            <div class='left flex flex-col gap-24 lg:gap-18 lg:border-r pt-0 lg:py-10 px-20 sm:w-[800px] lg:w-auto'>
                <!--  Overview  -->
