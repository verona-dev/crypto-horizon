...
<template>
    ...
    >
        <NavigationMenuList class="center shadow-blackA7 m-0 flex list-none rounded-[6px] bg-white p-1 shadow-[0_2px_10px]">
            ...
            <NavigationMenuItem>
                <NavigationMenuLink
                    class="text-grass11 hover:bg-green-100 focus:shadow-green7 block select-none rounded-[4px] px-3 py-2 text-[15px] font-medium leading-none no-underline outline-none focus:shadow-[0_0_0_2px]"
                    href="/"
                >
                    Crypto Horizon
                </NavigationMenuLink>
            ...
            <NavigationMenuItem>
                <NavigationMenuTrigger
                    class="hover:bg-green-100 focus:shadow-green group flex select-none items-center justify-between gap-[2px] rounded-[4px] px-3 py-2 text-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px]"
                >
                    Markets
                    <Icon
            ...
            <NavigationMenuItem>
                <NavigationMenuTrigger
                    class="text-grass11 hover:bg-green-100 focus:shadow-green7 group flex select-none items-center justify-between gap-[2px] rounded-[4px] px-3 py-2 text-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px]"
                >
                    Defi
                    <Icon
                        icon="radix-icons:caret-down"
