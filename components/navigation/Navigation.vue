...
<template>
    ...
    >
        <NavigationMenuList class='center shadow-black flex list-none rounded-[6px] p-6 shadow-[0_2px_10px]'>
            <!--  Logo  -->
            <NavigationMenuItem>
                <NavigationMenuLink
                    class='hover:bg-green-100 dark:hover:bg-emerald-600 focus:shadow-green-300 block select-none rounded-[4px] py-4 px-4 text-[15px] font-medium leading-none no-underline outline-none focus:shadow-[0_0_0_2px]'
                    href='/'
                >
                    Crypto Horizon
                </NavigationMenuLink>
            ...
            <NavigationMenuItem>
                <NavigationMenuTrigger
                    class='hover:bg-green-100 dark:hover:bg-emerald-600 focus:shadow-green-300 group flex select-none items-center justify-between gap-[2px] rounded-[4px] py-4 px-4 text-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px]'
                >
                    Markets
                    <Icon
