...
<template>
  <TabsTrigger
    ...
    :class="cn(
      `w-72 py-5 data-[state=active]:bg-background dark:data-[state=active]:bg-accent-foreground hover:bg-accent-foreground
      ...
      focus-visible:ring-ring/50 inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 rounded-sm text-sm font-medium
